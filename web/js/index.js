...
(async () => {
    ...
    function drawLeaderArrow(
        ...
        const isOnScreen =
            ...
            leaderScreenX < app.renderer.width - margin &&
            leaderScreenY > margin &&
            leaderScreenY < app.renderer.height - margin;
    ...
    function updateLeaderboard(players, myPlayerID) {
        ...
        const x = app.renderer.width - width - 20;
        const y = 20;
        ...
        const totalHeight =
            headerHeight + totalEntries * entryHeight + padding * 2;
    ...
    function updateHealthBar(health, maxHealth) {
        const barWidth = 400;
        const barHeight = 30;
        const x = app.renderer.width / 2 - barWidth / 2;
        const y = app.renderer.height - 60;
    ...
    function showCardSelection(cards) {
        ...
        let offsetX = (app.renderer.width - totalWidth) / 2;
        ...
        cards.forEach((card) => {
            ...
            cardContainer.position.set(
                offsetX,
                app.renderer.height / 2 - cardHeight / 2,
            );
        ...
        (gameState) => {
            ...
            if (network.myPlayerID) {
                ...
                if (serverPlayer) {
                    ...
                    localPlayer.active_effects =
                        serverPlayer.active_effects || [];

                    updateHealthBar(localPlayer.health, localPlayer.maxHealth);
                    updateBarrierBar(
                        localPlayer.barrier,
                        localPlayer.maxBarrier,
                    );
    ...
    function updateLocalPlayer() {
        ...
        const effectiveSpeed =
            localPlayer.speed * (1.0 - localPlayer.slowEffect);
    ...
    function updateCameraLocal() {
        ...
        world.x = -localPlayer.x * zoomFactor + app.renderer.width / 2;
        world.y = -localPlayer.y * zoomFactor + app.renderer.height / 2;
    }
    ...
    function updateBarrierBar(barrier, maxBarrier) {
        ...
        const barHeight = 20;
        const x = app.renderer.width / 2 - barWidth / 2;
        const y = app.renderer.height - 100;
